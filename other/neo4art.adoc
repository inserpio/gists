...
During his stage in *Antwerp*, among others, he depicted *_Backyards of Old Houses in Antwerp in the Snow_*:
...
In *Saint-Rémy de Provence*, Van Gogh painted *_Starry Night_*:
...
In *Auvers-sur-Oise*, *_Van Gogh painted Wheat Field with Crows_*:
