...
In May 2004, I founded LARUS Business Automation, a software company based in Mestre-Venice.
We're expert in designing and building custom software, powered by the latest technologies.
In 2014 we have also become neo4j solution partner. See more on our company site: http://www.larus-ba.it[]
