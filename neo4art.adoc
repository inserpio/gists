...
RETURN artist.first_name + ' ' + artist.last_name as artist, art_movement.name as art_movement
----
...
RETURN artist.first_name + ' ' + artist.last_name as artist, stage.from, stage.to, city.name, city.country, artwork.title, visual_art.name
...
RETURN person.first_name + ' ' + person.last_name as person, city.name, city.country, type(likes_or_posted) as likes_or_posted, likes_or_posted.url as post_url, coalesce(something_he_or_she_likes.name, something_he_or_she_likes.last_name, something_he_or_she_likes.title) as subject
