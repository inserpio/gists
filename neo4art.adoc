...
image::https://inserpio.files.wordpress.com/2014/09/van-gogh-self-border.png[width="400",align="center",link="https://inserpio.files.wordpress.com/2014/09/van-gogh-self-border.png"]
...
Please also note that I'm saving latitude and longitude informations for http://inserpio.wordpress.com/2014/09/21/neo4art-moves-to-cloud-foundry-at-springone-2gx-2014/[*future*] geo-spatial queries: at present, I'm just supposing this is the correct way to store such kind of data.
...
image::https://inserpio.files.wordpress.com/2014/09/olive-trees.png[width="550",align="center",link="https://inserpio.files.wordpress.com/2014/09/olive-trees.png"]
...
image::https://inserpio.files.wordpress.com/2014/09/pont-de-langlois.png[width="550",align="center",link="https://inserpio.files.wordpress.com/2014/09/pont-de-langlois.png"]

http://en.wikipedia.org/wiki/Nuenen[*Neuen*]:
...
http://en.wikipedia.org/wiki/Antwerp[*Antwerp*]:
...
http://en.wikipedia.org/wiki/Paris[*Paris*]:
...
http://en.wikipedia.org/wiki/Arles[*Arles*]:
...
http://en.wikipedia.org/wiki/Saint-R%C3%A9my-de-Provence[*Saint-Rémy de Provence*]:
...
http://en.wikipedia.org/wiki/Auvers-sur-Oise[*Auvers-sur-Oise*]:
...
image::https://inserpio.files.wordpress.com/2014/09/blossoming-almond-tree.png[width="550",align="center",link="https://inserpio.files.wordpress.com/2014/09/blossoming-almond-tree.png"]
...
image::https://inserpio.files.wordpress.com/2014/09/starry-night.png[width="550",align="center",link="https://inserpio.files.wordpress.com/2014/09/starry-night.png"]
...
image::https://inserpio.files.wordpress.com/2014/09/still-life-with-20-sunflowers.png[width="400",align="center",link="https://inserpio.files.wordpress.com/2014/09/still-life-with-20-sunflowers.png"]
...
image::https://inserpio.files.wordpress.com/2014/09/terrasse-des-cafc3a9s.png[width="400",align="center",link="https://inserpio.files.wordpress.com/2014/09/terrasse-des-cafc3a9s.png"]
...
image::https://inserpio.files.wordpress.com/2014/09/the-church-in-auvers-sur-oise.png[width="400",align="center",link="https://inserpio.files.wordpress.com/2014/09/the-church-in-auvers-sur-oise.png"]
...
image::https://inserpio.files.wordpress.com/2014/09/wheat-field-with-crows.png[width="800",align="center",link="https://inserpio.files.wordpress.com/2014/09/wheat-field-with-crows.png"]
